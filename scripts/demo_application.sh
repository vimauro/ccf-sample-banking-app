...
# Verify receipt
curl ${server}/app/receipt?transaction_id=$transfer_transaction_id --cacert service_cert.pem --key user0_privk.pem --cert user0_cert.pem -s | ../../scripts/verify_receipt.sh
